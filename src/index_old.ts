...
// import { validateWhitelist, validateBlacklist, validateWhitelistNew, validateWhitelistV2 } from "@/utils/index.js";
...
//     return {
//       is_valid: false,
//       error_message: options?.error_messages?.type_error ?? `${options?.error_label ?? "String"} should be a string`
//     };
//   }
//   if (isNil(options)) return { is_valid: true };

//   const { required, whitelist, blacklist, error_label, error_messages } = options;

//   if (required && !value) {
//     return {
//       is_valid: false,
//       error_message: error_messages?.required_error ?? `${error_label ?? "String"} should not be empty`
//     };
//   }
//   if (whitelist) {
...
//       error_message: error_messages?.whitelist_error
//     });
